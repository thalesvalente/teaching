...
@autores: [Keven Gustavo Dos Santos Gomes],[Lucas Emanoel Amaral Gomes]
@contato: [keven.gustavo@discente.ufma.br],[lucas.amaral@discente.ufma.br]
@data última versão: [18/02/2025]
@versão: 1.0
@outros repositórios: [https://github.com/KevenGustavo/Maquina-Turing-Multiplicadora-de-Binarios.git]
